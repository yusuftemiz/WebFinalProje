...
<%@page import="com.eticaret.DAO.KategoriDAO" %>
    ...
    top: -52px;">
                        <form role="form" action="urunekle" method="post"  enctype="multipart/form-data">
                            
                            <fieldset>                                
                                <div class="form-group">                                   
									<select class="form-control" name="formKategori" style="    width: 415px;height: 46px;">
										<option value="2">ELEKTRONİK</option>
										<option value="1">EV</option>
										<option value="3">KİTAP</option>
									</select>
                                </div>
    ...
    color: blue;" class="btn btn-lg btn-success btn-block">Ürün Ekle</button>
                            </fieldset>
                        </form>
                    </div>
                </div>
